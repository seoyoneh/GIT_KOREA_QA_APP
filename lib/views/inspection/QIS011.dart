...
class QIS011 extends ConsumerStatefulWidget {
  const QIS011({super.key});

  @override
  ConsumerState<QIS011> createState() => _QIS011State();
}

class _QIS011State extends ConsumerState<QIS011> {
  //-------------------------------------
  // VARIABLE
  //-------------------------------------
  ...
  List<RadioType> checkProblems = [
    RadioType(
      id: 1,
      label: "QIS011.problemNo".tr(),
      value: "NO",
      isSelected: true
    ),
    RadioType(
      id: 1,
      label: "QIS011.problemYes".tr(),
      value: "YES",
      isSelected: false
    )
  ];
  ...
  void initState() {
    ...
    actionResultNode.addListener(() {
      if(actionResultNode.hasFocus) {
        // setState(() {
        //   _isCollapsed = true;
        //   _containerHeight = 0;
        // });
    ...
    inspectionResultTabs = [
      TabItem(
        code: "weekInitial",
        title: "QIS011.weekInitial".tr(),
        isSelected: true,
      ),
      TabItem(
        code: "weekMiddle",
        title: "QIS011.weekMiddle".tr(),
        isSelected: false,
      ),
      TabItem(
        code: "nightInitial",
        title: "QIS011.nightInitial".tr(),
        isSelected: false,
      ),
      TabItem(
        code: "nightMiddle",
        title: "QIS011.nightMiddle".tr(),
        isSelected: false,
      )
    ];
                ...
                slivers: [
                  SliverList(
                    delegate: SliverChildListDelegate([
                          ...
                          child: Row(
                            ...
                            children: [
                              QisCheckbox(
                                ...
                                label: "QIS011.inspectionLabel".tr(),
                              ),
                      ...
                      const SizedBox(height: 10),
                      // 작성일자
                      _buildTitle("QIS011.writingDate".tr()),
                      _buildContentBox(
                      ...
                      _buildContentBox(
                        content: CalendarTextField(
                          ...
                          calendarTitle: "QIS011.configLotNo".tr(),
                          style: PretendardStyle.regular.copyWith(
                            fontSize: 18,
                            color: QisColors.gray900.color
                          ),
                      ...
                      const SizedBox(height: 20),
                      // 이상유무
                      _buildTitle("QIS011.checkProblem".tr()),
                      const SizedBox(height: 20),
                      _buildContentBox(
                        content: RadioGroup(
                          items: checkProblems,
                      ...
                      const SizedBox(height: 20),
                      // 조치결과
                      _buildTitle("QIS011.actionResult".tr()),
                      _buildContentBox(
                        content: UnderlineTextField(
                          controller: actionResultController,
                          focusNode: actionResultNode,
                          hintText: "QIS011.actionResultHint".tr(),
                          style: PretendardStyle.regular.copyWith(
                            fontSize: 18,
                            color: QisColors.gray900.color
                          ),
  ...
  void _gotoInspectionOrderView() {
    ApplicationData.getInstance().inspectionCheckType = InspectionCheckType.create(
      ...
      fileType: InspectionFileType.PDF,
      isChecked: false
    );
