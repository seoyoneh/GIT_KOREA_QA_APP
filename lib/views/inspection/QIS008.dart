...
class QIS008 extends ConsumerStatefulWidget {
  const QIS008({super.key});

  @override
  ConsumerState<QIS008> createState() => _QIS008State();
}

class _QIS008State extends ConsumerState<QIS008> {
  //-------------------------------------
  // VARIABLE
  //-------------------------------------
  ...
  Widget _buildListItem(BuildContext context, int index) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          GoRouter.of(context).push(RoutePath.QIS010.path);
        },
        child: Container(
