...
class QIS005 extends ConsumerStatefulWidget {
  const QIS005({super.key});

  @override
  ConsumerState<QIS005> createState() => _QIS005State();
}

class _QIS005State extends ConsumerState<QIS005> {
  //-------------------------------------
  // VARIABLE
  //-------------------------------------
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      UnderlineTextField(
                        ...
                        hintText: "QIS005.password".tr(),
                        isPassword: true,
                      ),
                      const SizedBox(height: 40),
                      SimpleButton(
                        text: "QIS005.login".tr(),
