...
class QIS006 extends ConsumerStatefulWidget {
  const QIS006({super.key});

  @override
  ConsumerState<QIS006> createState() => _QIS006State();
}

class _QIS006State extends ConsumerState<QIS006> {
  //-------------------------------------
  // VARIABLE
  //-------------------------------------
  ...
  final List<RadioButtonType> _businessTypeList = [
    RadioButtonType.create(id: 1, value: "ULSAN", label: "QIS006.ulsan".tr(), isSelected: true),
    RadioButtonType.create(id: 2, value: "ASAN", label: "QIS006.asan".tr()),
  ];
  late RadioButtonController _businessTypeController;

  final List<RadioButtonType> _workTypeList = [
    RadioButtonType.create(id: 1, value: "DAY", label: "QIS006.day".tr(), isSelected: true),
    RadioButtonType.create(id: 2, value: "NIGHT", label: "QIS006.night".tr()),
  ];
        ...
        children: [
          ...
          Container(
            ...
            child: SimpleButton(
              ...
              radius: 6,
              onPressed: () {
                GoRouter.of(context).push(RoutePath.QIS008.path);
              }
            )
          ),
